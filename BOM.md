...
|---|---|---|---|---|
| Stepper motor, NEMA 17 | `42DND0155B-22` (Kaihong) | 42 mm frame, 40 mm body, 1.8°/step, 1.65 A, 2.72 V, ≥0.4 N·m, Ø5 D-shaft ×22 mm, JST PH-6P connector. Spec: `cad/nema17-stepper.pdf`. Generic 17HS4401-class motors are near-identical substitutes. | 2 | [STEPPERONLINE](https://www.omc-stepperonline.com/nema-17-stepper-motor) · [Amazon US](https://www.amazon.com/17HS4401-Stepper-42BYGH-4-Lead-Printer/dp/B098L26QXZ) · [AliExpress](https://www.aliexpress.us/item/3256802822821809.html) · [eBay](https://www.ebay.com/itm/266301337718) |
| Leadscrew | Tr8×8 (T8, 4-start, 8 mm lead) | Firmware: 8 mm travel/rev (`mmPerRevolution = 8`). ⚠️ Length ~175 mm inferred from ~186 mm frame width — cut 200 mm stock to length. | 2 | [Amazon US (200 mm, 2 pcs)](https://www.amazon.com/Length-Diameter-Thread-Printer-Kwweeoo/dp/B0CK29R5R4) · [Amazon US (FKG 200 mm)](https://us.amazon.com/FKG-200mm-Lead-Screw-Brass/dp/B08JP2ZPWF) · [AliExpress search](https://www.aliexpress.com/w/wholesale-t8-lead-screw-200mm-8mm-lead.html) |
| Leadscrew nut, brass | Tr8×8 | Brass nut per axis (hex-style nut visible in CAD render). ⚠️ Exact style (hex vs flange vs anti-backlash) to confirm. | 2 | [Amazon US (flange)](https://www.amazon.com/Screw-T8x8mm-Flange-Printer-Accessories/dp/B089G5C8TN) · [AliExpress search](https://www.aliexpress.com/w/wholesale-t8-nut-8mm-lead-brass.html) |
| Guide rail, smooth | Ø14 h6 linear shaft | ⚠️ Ø14 inferred from Ø14.03 ±0.05 bores in `cad/clampsled.pdf` and Ø14.05 in `y-sled-bottom.step`; sleds appear to ride the shafts directly (plain bore — no linear ball bearings found in CAD). Hardened + hard-chromed, ~175 mm, 2 per axis. | 4 | [McMaster-Carr](https://www.mcmaster.com/products/hard-chrome-rods) · [Misumi](https://us.misumi-ec.com/vona2/mech/M0100000000/M0101000000/?CategorySpec=00000028940%3A%3Ab) · [Amazon US](https://www.amazon.com/QXCIVR-Linear-Cylinder-Optical-100-500mm/dp/B0DRTRKRJ6) · [ZYLtech](https://www.zyltech.com/store/lead-screws-rods-and-rails/chrome-plated-smooth-rods-shafts/) |
| Bearing, 608 | 608-2RS / 608ZZ | 8×22×7 mm. ⚠️ Implied by `cad/608-tool-grip.step` / `608-tool-tip.step` — usage (leadscrew end support vs. assembly tool) and quantity to confirm. | 2+ | [Amazon UK search](https://www.amazon.co.uk/s?k=608-2rs+bearing) · [eBay search](https://www.ebay.com/sch/i.html?_nkw=608-2rs+bearing) |

## 2. Engraver ("hammerhead")

| Part Name | Part Number | Description / Spec | Qty | Vendor(s) |
|---|---|---|---|---|
| Solenoid impact head | — (OEM, per `specs/hammerhead.pdf`) | Ø40 × 71 mm, M26 threaded neck, 90° carbide tip, 16 cm cable → JST XH 2-pin female. Driven 20–28 V DC, 25 ms cycle (≈40 Hz), 4–5 ms on-time. ⚠️ The drawing is an interface spec for an OEM commodity marking-machine head — **exact OEM/source unknown; input from the SeedHammer team wanted.** DIY fallback: harvest the head from a 400 W desktop electric marking machine and verify the coil at 20–28 V pulsed drive. | 1 | Donor machines: [VEVOR 400 W](https://www.vevor.com/marking-machine-c_10477/400w-electric-metal-marking-engraving-machine-200x150mm-50mm-s-nameplate-110v-us-p_010564478831) · [Amazon US](https://www.amazon.com/Electric-Marking-Engraving-Nameplate-Industrial/dp/B0CQM15DMF) · [eBay](https://www.ebay.com/itm/396843277487) |
...
| Power supply | USB-C PD 3.1 | 100 W minimum, **140 W (28 V EPR) recommended**; single-port preferred. | 1 | [Anker 140 W (A2697)](https://www.anker.com/products/a2697-anker-charger-140w-4-port) · [Amazon UK search](https://www.amazon.co.uk/s?k=140W+USB-C+PD+3.1+charger) |
| USB-C cable | 240 W / EPR-rated | Must be EPR e-marked or the supply falls back to 100 W / 20 V. | 1 | [Amazon UK search](https://www.amazon.co.uk/s?k=usb-c+cable+240w+epr) |

## 4. Cables & connectors

| Part Name | Part Number | Description / Spec | Qty | Vendor(s) |
|---|---|---|---|---|
| Motor cable | JST PH 2.0 6-pin → JST XH 2.5 4-pin | Motor side PH-6P (pins 1/3/4/6 = A+/A−/B−/B+), board side XH 4-pin (`B4B-XH-A`). Standard "PH6–XH4 stepper cable" or crimp your own. ⚠️ Length TBD (~30 cm). | 2 | [AliExpress search](https://www.aliexpress.com/w/wholesale-stepper-motor-cable-ph2.0-6pin-xh2.54-4pin.html) · [Amazon UK search](https://www.amazon.co.uk/s?k=stepper+motor+cable+ph2.0+xh2.54) |
...
| JST crimp kit | XH + PH assortment | For making motor/aux leads (plus 2× SH 1.0 3-pin debug wafers on board). | 1 | [Amazon UK search](https://www.amazon.co.uk/s?k=jst+xh+ph+connector+kit) |
...
|---|---|---|---|
| Screw assortment | M3 + M4 socket-head (motor mounts 4× M3 each, ≥4.5 mm engagement; clamp M4×0.7; frame M3/M4 per STEP threads). ⚠️ Exact list TBD. | 1 kit | [Amazon UK search](https://www.amazon.co.uk/s?k=m3+m4+socket+head+screw+assortment) |
